...
public class FirstFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onViewCreated(@NonNull  View view, @Nullable  Bundle savedInstanceState) {
        ...
        //requestList.add(new Request("test","test","test","0","0",null, "28/5/2021","",""));
        reference = FirebaseDatabase.getInstance().getReference("Request");
        Query checkRequests = reference.orderByChild("status").equalTo("0");
    ...
    {
        listView = view.findViewById(R.id.lvDonHangFirst);
